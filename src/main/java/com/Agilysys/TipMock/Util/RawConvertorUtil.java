...
public class RawConvertorUtil {

    public static void convertAvroToJson(InputStream inputStream, OutputStream outputStream, Schema schema)
            throws IOException {
   ...
   public static void convertJsonToAvro(InputStream inputStream, OutputStream outputStream, Schema schema)
            throws IOException {
        DatumReader<Object> reader = new GenericDatumReader<>(schema);
        DatumWriter<Object> writer = new GenericDatumWriter<>(schema);
